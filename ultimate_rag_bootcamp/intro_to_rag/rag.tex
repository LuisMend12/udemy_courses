...
\section*{Pros}
\begin{itemize}
    \item No technical expertise need
    \item Instant results
    \item No training cost (frec)
    \item Works with any LLM
\end{itemize}

\section*{Cons}
\begin{itemize}
    \item Limited by models basic knowledge
    \item Inconsistent results
    \item Token limit restrict complexity 
    \item can't add new knowledge to the model
\end{itemize}

\section*{Best for}
\begin{itemize}
    \item Small scale applications
    \item Generic purpose task
